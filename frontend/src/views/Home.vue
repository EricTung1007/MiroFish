...
:root {
  ...
  --border: #E5E5E5;
  /* 
    使用 Space Grotesk 作為主要標題字體，JetBrains Mono 作為代碼/標籤字體
    確保已在 index.html 引入這些 Google Fonts 
  */
...
.console-box {
  border: 1px solid #CCC; /* 外部實線 */
  padding: 8px; /* 內邊距形成雙重邊框感 */
}
