"""
測試Profile格式生成是否符合OASIS要求
驗證：
1. Twitter Profile生成CSV格式
2. Reddit Profile生成JSON詳細格式
"""
...
def test_profile_formats():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"   [信息] 可選字段: {present_optional}")
