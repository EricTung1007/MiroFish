...
使用方式:
    ...
    python run_twitter_simulation.py --config /path/to/simulation_config.json --no-wait  # 完成後立即關閉
"""
...
class TwitterSimulationRunner:
    ...
    def _get_profile_path(self) -> str:
        """獲取Profile文件路徑（OASIS Twitter使用CSV格式）"""
...
async def main():
    parser = argparse.ArgumentParser(description='OASIS Twitter模擬')
    parser.add_argument(
        '--config', 
        type=str, 
        required=True,
